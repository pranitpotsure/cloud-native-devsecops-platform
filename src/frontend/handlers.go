...
func (fe *frontendServer) homeHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Set ENV_PLATFORM from environment variable only (no GCP metadata calls)
	// Valid values: local, gcp, aws, azure, onprem, alibaba
	// For AWS deployment: set ENV_PLATFORM=aws in task definition / pod spec
